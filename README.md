...
Несмотря на [предупреждение](https://blog.ploeh.dk/2016/03/18/functional-architecture-is-ports-and-adapters/) Марка Симана, была выбрана ахритектура портов и адаптеров. Микросервис при этом представлен следующими слоями:
1. Доменная модель.
2. Доменные сервисы.
